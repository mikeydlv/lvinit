...
> fix this file.
>
> **Last audited:** 2026-09-21 · **Branch:** `main` · **Live:** https://www.lvinit.com
>
...
app/
  ...
  guides/las-vegas-mortgage-rates-hit-20-month-high/page.tsx  /guides/las-vegas-mortgage-rates-hit-20-month-high — Market Watch, the third mortgage-rates sequel: Freddie Mac's weekly average jumped 19 bps to 6.95% the week of Sept 17, 2026 (highest since January 2025) and daily trackers held above 7% for days (Story Page system)
```
...
| `/guides/las-vegas-mortgage-rates-hit-20-month-high` | Market Watch guide | Live | Story Page system; built via the autonomous scheduled editorial-publishing routine as the third sequel in the mortgage-rates series (after `las-vegas-mortgage-rates-september-2026` and `las-vegas-mortgage-rates-approach-7-percent`). Fresh news independently verified this run: Freddie Mac's own PMMS (`freddiemac.com/pmms` + `/archive`) shows the 30-year fixed jumped from 6.76% to 6.95% for the week of Sept 17, 2026 — a 19 bps move, roughly 4x any single week's change in the five weeks before it, and 15-year 6.09% → 6.26%. Independently corroborated "highest since January 2025" / 20-month-high framing via a Reuters wire story (fetched via its Investing.com syndication, cross-checked against U.S. News) — the Reuters copy itself carries no economist quote or stated cause, so none is invented here; the piece explicitly says what it doesn't know instead of guessing. Daily-tracker context (Zillow data via Yahoo Finance, Sept 19, 2026: 30-year 7.04%) shows the daily numbers have now held above 7% for several days, not just touched it once, which is the new fact this piece adds. Local price context reuses the already-sourced $475,000 August 2026 LVR median; confirmed no LVR September 2026 report exists yet. Financing-cost topic, not a place — `C:\LVINIT\Images` confirmed unreachable from this Linux cloud session (no `/mnt/c` mount) — so it ships with a photoless `StoryHero` and a generated LVINIT editorial cover as the `/guides` card image only (`covers/las-vegas-mortgage-rates-20-month-high-editorial-cover.webp`); the prior two pieces' Mikey-supplied AI hero images were explicitly approved piece-by-piece and that approval doesn't carry over automatically. FAQPage + Article + Breadcrumb JSON-LD; cross-linked both directions with `las-vegas-mortgage-rates-approach-7-percent` (new "Update:" paragraph + `relatedStories` entry on that page, pointing here), plus links to `las-vegas-home-prices-august-2026`, `las-vegas-starter-home-prices-2026`, `las-vegas-down-payment-assistance-programs-2026`, `what-500k-buys-in-las-vegas`, and `/search`; sitemap entry; registered in `lib/content.ts` `guides[]`. |
