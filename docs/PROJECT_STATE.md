...
- **Monument Hills** Local Feature guide — built via the autonomous scheduled
  ...
  No real photography exists for this still-vacant site and `C:\LVINIT\Images`
  wasn't reachable this run, so it carries a generated LVINIT editorial cover
  and a photoless hero. Story Page system; Article + Breadcrumb JSON-LD;
...
- **Henderson photography** — ✅ **Hero resolved 2026-08-27.** The guide runs
  ...
  re-measured before it ships. Still wanted, in rough
