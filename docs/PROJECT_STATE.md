...
- **Henderson photography** — ✅ **Hero resolved 2026-08-27.** The guide runs
  ...
  live on `/guides/water-street-district-henderson`: a greyscale gateway-arch
  shot as the hero/card image and a color streetscape (MacKenzie's River Pub)
  as an inline figure. Still wanted, in rough priority order: Green Valley's
