...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    {
      url: `${BASE_URL}/guides/las-vegas-mortgage-rates-hit-20-month-high`,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
    ...
    {
      url: `${BASE_URL}/guides/water-street-district-henderson`,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${BASE_URL}/guides/fiesta-henderson-redevelopment`,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${BASE_URL}/guides/sandstone-tule-springs-north-las-vegas`,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${BASE_URL}/guides/las-vegas-home-prices-august-2026`,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
    ...
    {
      url: `${BASE_URL}/guides/new-build-vs-resale-las-vegas`,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
