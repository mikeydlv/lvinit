  ...
  return (
    <StoryPage
      ...
      hero={{
        ...
        headline: "Summerlin vs. Henderson: Where Should You Actually Move?",
        subheadline:
          "Two of the city's most-recommended suburbs, compared honestly on master-plan culture, commute, community character, and the tradeoffs nobody puts in a brochure.",
        image: "/images/hero/summerlin-fox-hill-park-red-rock-aerial-drone.webp",
        imageAlt:
          "Aerial view of Fox Hill Park in Summerlin with Red Rock Canyon in the background, photographed by Mikey Del Rosario.",
    ...
    >
      ...
      <StorySection heading="Where you actually land">
        <p className="text-body-lg text-lvinit-warmgray">
          ...
          when the 215 has other plans. If your life is anchored east, with an
          office off the Strip or family in Henderson, that&rsquo;s a real
      ...
      <StorySection heading="So, which one actually wins?">
        ...
        <p className="mt-5 text-body-lg text-lvinit-warmgray">
          ...
          want to live day to day. For that, the honest next step is
