  ...
  return (
    <StoryPage
      ...
      ctas={{
        ...
        body:
          "One month of softer prices doesn't tell you what to do with your specific budget and timeline. Tell me what you're working with, and I'll walk you through what the data actually means for your decision. No sales pitch.",
      }}
    >
      <StoryLede
        kicker="Market Watch"
      ...
      >
        <p className="mt-6 text-body-lg text-lvinit-warmgray">
          ...
          seriously. It&rsquo;s also a single month and a modest percentage.
          And as the numbers underneath it show, it&rsquo;s not the same story
          in every corner of the market. Here&rsquo;s what actually happened,
          and what it does and doesn&rsquo;t mean.
        </p>
      </StoryLede>
      ...
      <StorySection heading="The nuance worth understanding: single-family and condos aren't moving the same way">
        ...
        <p className="mt-5 text-body-lg text-lvinit-warmgray">
          ...
          days, down from 73.5% a year earlier. That&rsquo;s a real slowdown,
          paired with sales that were down 1.1% year over year. If you only look at the
      ...
      <StorySection heading="Sources">
        <ul className="space-y-3 text-body text-lvinit-warmgray">
          ...
          <li>
            ...
            coverage confirming the same LVR figures at{" "}
            <a
          ...
          <li>
            ...
            August 6, 2026) and 6.67% (week of August 13, 2026) at{" "}
            <a
