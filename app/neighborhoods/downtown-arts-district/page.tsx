  ...
  return (
      ...
      relatedStories={{
        ...
        stories: [
          ...
          },
          {
            ...
            category: "Neighborhood guide",
            dek: "Its own city at the north end, with established streets, big master-plans, and brand-new desert growth.",
          },
          {
    ...
    >
      <StoryLede
        ...
        lead="Most of Las Vegas asks you to drive. The Arts District is the rare corner that asks you to walk. It's a low, sun-bleached, mural-covered stretch of Main Street just north of the Strip, where galleries, coffee counters, vintage shops, and bars sit shoulder to shoulder instead of behind a parking lot."
      >
      ...
      <StorySection heading="Genuinely walkable, by Vegas standards">
        <p className="text-body-lg text-lvinit-warmgray">
      ...
      <StorySection heading="Coffee, food, bars, vintage, and galleries">
        <p className="text-body-lg text-lvinit-warmgray">
          ...
          and working art galleries. The names turn over, which is the
      ...
      <StorySection heading="What's being built: the housing question">
        ...
        <p className="mt-5 text-body-lg text-lvinit-warmgray">
          ...
          That&rsquo;s exactly why I won&rsquo;t hand you a price or a rent figure on
      ...
      <StorySection heading="Parking, heat, noise, and nightlife hours">
        <p className="text-body-lg text-lvinit-warmgray">
          ...
          and busy weekend nights, so plan for it. The heat is real: these photos
        ...
        <p className="mt-5 text-body-lg text-lvinit-warmgray">
          ...
          And the daily rhythm is genuinely nocturnal-leaning, with sleepy
          mornings and lively nights. If you&rsquo;re an early-to-bed person, live a block or
