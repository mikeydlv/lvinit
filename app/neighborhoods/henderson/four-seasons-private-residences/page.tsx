  ...
  return (
    <StoryPage
      ...
      relatedNeighborhood={{
        ...
        href: "/neighborhoods/henderson",
        blurb:
          "The full, honest guide to the city this sits in, covering every community from the new master-plans to the hillside.",
      }}
      ctas={{
    ...
    >
      <StoryLede
        ...
        lead="Some homes you understand from a floor plan. This isn't one of them. Four Seasons Private Residences sits high in Henderson's MacDonald Highlands, where the valley falls away below you and the McCullough foothills rise behind. It's a setting that does more of the talking than any brochure could."
      >
      ...
      <StorySection heading="Why MacDonald Highlands">
        <p className="text-body-lg text-lvinit-warmgray">
          ...
          southeast edge. It&rsquo;s the luxury, view-first corner of the{" "}
          <Link
      ...
      <StorySection muted heading="What it says about Henderson">
        ...
        <p className="mt-5 text-body-lg text-lvinit-warmgray">
          ...
          estate, and that there&rsquo;s now a buyer here who wants the penthouse
      ...
      <StorySection
        ...
        paragraphs={[
          "One LVINIT rule, applied here as everywhere: we won't hand you numbers we can't stand behind. Pricing, availability, finishes, and timing all move on a development like this, and they're too important to take from a brochure or a third-hand listing.",
